...
urlpatterns = [
	...
	url(r'messages/(?P<username>[A-Za-z0-9-._]+)$', views.messages_view, name='messages-view'),
	url(r'messages/(?P<username>[A-Za-z0-9-._]+)/read$', views.messages_read, name='messages-read'),
