# -*- coding: utf-8 -*-
# Generated by Django 1.10.7 on 2017-08-12 20:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relation_visibility', models.SmallIntegerField(choices=[(0, 'show'), (1, 'friends only'), (2, 'hide')], default=0)),
        ...
        migrations.AddField(
            model_name='notification',
            name='merged_with',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='closedverse_main.Notification'),
        ),
        migrations.AddField(
            model_name='notification',
            name='source',
